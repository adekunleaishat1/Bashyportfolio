  ...
  return (
    <div>
     ...
     <Navbar/>
      ...
      <div id="skills"  className=" bg-[#121212] py-10 px-8 md:px-12">
      ...
      <div id="project" className="py-10 px-8 md:px-12 bg-[#121212] ">
         <div className="mx-auto max-w-[1200px] h-auto">
            ...
            <aside className="rounded-xl h-[4px] bg-gradient-to-l from-[#c084fc] to-[#db2777]  w-[250px]"></aside>
              <div className="mt-6 py-4  mx-auto max-w-[1300px] px-0 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
               <div className="w-full px-0 md:px-3 py-4 ">
                  <div className="w-auto md:max-w-[500px] h-[300px] mb-8">
                  <img className="w-full h-full" src={mavenmarket} alt="" />
                  </div>
                  <div className="">
                    <h1 className= "text-[16px] md:text-xl font-bold text-[#fff] mb-5"> Maven Market Dashboard</h1>
                    <p className="text-[14px] md:text-[16px] text-[#fff] mb-5">Insights into Sales, Orders, and Customer Performance
                ...
                <div className="w-full px-0   md:px-3 py-4 rounded-md">
                  ...
                  <div className="">
                    <h1 className="text-[16px] md:text-xl font-bold text-[#fff] mb-5">Superstore Dashboard</h1>
                    <p className="text-[14px] md:text-[16px] text-[#fff]  mb-5">Comprehensive Insights into Sales and Profit Performance
                ...
                <div className="w-full px-0  md:px-3 py-4 mt-3">
                  ...
                  <div className="">
                    <h1 className="text-[16px] md:text-xl font-bold text-[#fff] mb-5">Call Center Performance Dashboard</h1>
                    <p className="text-[14px] md:text-[16px] text-[#fff]  mb-5">
                ...
                <div className="w-full px-0  md:px-3 py-4 rounded-md mt-3">
                  ...
                  <div className="">
                    <h1 className="text-[16px] md:text-xl font-bold text-[#fff] mb-5">Museum Data set</h1>
                    <p className="text-[14px] md:text-[16px] text-[#fff] mb-5">
                ...
                <div className="w-full px-0  md:px-3 py-4 rounded-md mt-3">
                  ...
                  <div className="">
                    <h1 className="text-[16px] md:text-xl font-bold text-[#fff] mb-5"> Employee Salary Analysis</h1>
                    <p className="text-[14px] md:text-[16px] text-[#fff] mb-5">
      ...
      <div className="bg-[#000] py-10 px-8 md:px-12" id="footer">
